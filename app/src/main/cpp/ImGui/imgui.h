...
namespace ImGui
{
    IMGUI_API float get_openAnimationState();
    IMGUI_API void set_openAnimationState(float val);

    IMGUI_API void  get_cmdExecutor(const char*);
    IMGUI_API bool  get_cmdExecutorHaveVal();
    IMGUI_API void set_cmdExecutor(void (*val)(const char *));
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, void( *onCheckAct)(int, bool) = NULL);
    ...
    void ShowExampleAppConsole(bool *pBoolean);
    void ShowExampleAppLog(bool* p_open);
     void ShowExampleAppCustomRendering(bool* p_open);

    bool
    ButtonEx2(const char *label, const ImVec2 &size_arg, ImGuiButtonFlags flags, ImColor colorr);

    bool Button2(const char *label, const ImVec2 &size_arg, ImColor colorr);
} // namespace ImGui
